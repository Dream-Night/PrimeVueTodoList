<template>
    <div>
    <DataTable :value="tasks" showGridlines stripedRows tableStyle="win-width: 50rem">
        <Column field="title" header="Task"></Column>
        <Column field="formattedDeadline" header="Day" sortable></Column>
        <Column field="formattedDeadlineTime" header="Time" sortable></Column>
        ...
        <Column field="status.id" header="Status" sortable>
